...
or_oper:
    ...
    ANDLW 0x0F ; Enmascaramiento bajo
    MOVWF Resultado
    MOVF LATD, W ; Mover a puerto

    ;ANDLW 0xF0 ; Enmascaramiento alto
    ;IORWF Resultado, W ; OR
    ;MOVWF LATD ; Mover el resultado
    GOTO LOOP
...
suma_oper:
    ...
    MOVWF Resultado
    SWAPF Resultado, W ; Cambiar
    ANDLW 0xF0 ; High bits Del 7 al 4
    MOVWF Resultado
    IORWF Resultado, W ; Suma
    MOVWF LATD ;Mover al puerto
