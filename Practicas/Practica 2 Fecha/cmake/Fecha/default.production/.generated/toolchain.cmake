...
set(MP_AS "c:/Program Files/Microchip/xc8/v3.10/pic-as/bin/pic-as.exe" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler")
set(MP_AS_DIR "c:/Program Files/Microchip/xc8/v3.10/pic-as/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler base directory")
set(CMAKE_ASM_COMPILER "c:/Program Files/Microchip/xc8/v3.10/pic-as/bin/pic-as.exe" CACHE FILEPATH "Path to the compiler binary.")

# Legacy variable from MPLAB X pointing to the assembler binary.
set(MP_AS ${CMAKE_ASM_COMPILER})

set(MP_LD "c:/Program Files/Microchip/xc8/v3.10/pic-as/bin/pic-as.exe" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")
set(MP_LD_DIR "c:/Program Files/Microchip/xc8/v3.10/pic-as/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the linker base directory")

set(MP_AR "c:/Program Files/Microchip/xc8/v3.10/pic-as/bin/pic-as.exe" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the archiver binary.")
set(MP_AR_DIR "c:/Program Files/Microchip/xc8/v3.10/pic-as/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the archiver base directory")

set(CMAKE_AR "c:/Program Files/Microchip/xc8/v3.10/pic-as/bin/pic-as.exe" CACHE FILEPATH "Path to the archiver binary.")
